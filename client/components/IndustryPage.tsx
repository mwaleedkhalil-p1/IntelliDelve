...
import { Shield, CheckCircle, Users, BarChart3, ArrowRight, Star, Award, TrendingUp, Building, Heart, Laptop, GraduationCap, Briefcase, FileCheck, Cog, AlertTriangle, Building2, Stethoscope, ShoppingCart, Utensils, Rocket, Calculator, Factory, Zap, Home } from "lucide-react";
...
const getIndustryAssets = (slug: string) => {
  const assets: { [key: string]: { image: string; color: string; icon: any; gradient: string } } = {
    ...
    "academic-education": {
      image: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=85",
      color: "orange",
      icon: GraduationCap,
            ...
            <div className="relative">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-200">Specialized solutions for {industry.title.toLowerCase()}</p>
                </div>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className={`inline-flex items-center px-4 py-2 rounded-full bg-${assets.color}-100 dark:bg-${assets.color}-900/30 text-${assets.color}-600 dark:text-${assets.color}-400 text-sm font-medium mb-6`}>
                <IconComponent className="w-4 h-4 mr-2" />
                Industry Overview
              </div>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 font-primary">
                Understanding Your
                <span className={`block text-transparent bg-clip-text bg-gradient-to-r ${assets.gradient}`}>
                  Industry Needs
                </span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  <div className={`text-3xl font-bold text-${assets.color}-600 dark:text-${assets.color}-400 mb-2`}>
                    24/7
                  </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Turnaround Time</p>
                </div>
              </div>
            </div>

            <div className="relative">
              <div className={`absolute -inset-4 bg-gradient-to-r ${assets.gradient} opacity-20 rounded-3xl blur-xl`}></div>
              <img
                src={assets.image}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto font-secondary">
              Comprehensive verification solutions tailored specifically for {industry.title.toLowerCase()}
            </p>
          </div>
            ...
            {industry.services.map((service, index) => (
              ...
              >
                <div className="flex items-start mb-4">
                  <div className={`p-3 bg-${assets.color}-100 dark:bg-${assets.color}-900/30 rounded-xl mr-4 group-hover:scale-110 transition-transform duration-300`}>
                    <CheckCircle className={`h-6 w-6 text-${assets.color}-600 dark:text-${assets.color}-400`} />
                  </div>
                ...
                <div className={`w-full h-1 bg-gradient-to-r ${assets.gradient} rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-2xl border border-gray-100 dark:border-gray-700">
                <div className="text-center">
                  <div className={`inline-flex items-center justify-center w-16 h-16 bg-${assets.color}-100 dark:bg-${assets.color}-900/30 rounded-full mb-6`}>
                    <Shield className={`h-8 w-8 text-${assets.color}-600 dark:text-${assets.color}-400`} />
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              See how we've helped organizations in {industry.title.toLowerCase()} achieve their goals
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-2xl border border-gray-100 dark:border-gray-700">
            <div className="grid lg:grid-cols-3 gap-8 items-center">
              <div className="text-center">
                <div className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r ${assets.gradient} rounded-full mb-4`}>
                  <BarChart3 className="h-10 w-10 text-white" />
                </div>
                <div className={`text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r ${assets.gradient} mb-2 font-primary`}>
                  {industry.story.stat}
                </div>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="flex items-center">
                  <div className="flex-1">
                    <div className="font-semibold text-gray-900 dark:text-white">Industry Leader</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">{industry.title}</div>
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-100 mb-8 leading-relaxed font-secondary">
                Let us help you implement comprehensive screening solutions tailored specifically for your {industry.title.toLowerCase()} organization.
              </p>
