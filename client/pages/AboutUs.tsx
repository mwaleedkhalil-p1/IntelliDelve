          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                Empowering Smarter Decisions with Verification, Compliance & AI
              </h1>
              <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
                Building global trust through background checks, due diligence,
                and data-driven intelligence.
              </p>
              <button
                onClick={() => openCalendly("About Us - Schedule Consultation")}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
              ...
              deliver AI-powered risk intelligence and compliance solutions that
              help organizations worldwide reduce fraud, accelerate hiring, and
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                ...
                investigators, and forensic experts ensure every verification is
                regionally compliant, culturally aware, and globally trusted.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              background screening, fraud detection, and compliance intelligence
              workflows. We've engineered intelligent systems that combine
              machine learning, natural language processing (NLP), and
              predictive analytics to flag red flags faster, improve accuracy,
